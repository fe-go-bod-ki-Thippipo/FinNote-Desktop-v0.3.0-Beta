# FinNote Desktop v0.3.0 Beta — Release Candidate Update

- แก้ปฏิทินรายการรับ–จ่ายให้เริ่มสัปดาห์วันอาทิตย์เหมือนบันทึกประจำวัน
- เพิ่มเดือนก่อน / วันนี้ / เดือนถัดไป และเปิดรายละเอียดรายวันจากปฏิทิน
- ปฏิทินแสดงเฉพาะยอด รับ / จ่าย / ชำระหนี้ / โอนเงิน ที่มากกว่า 0
- เพิ่มเมนู “จัดการแจ้งเตือน” สำหรับกติกางบประมาณ หนี้สิน เงินออม และรายการประจำ
- แจ้งเตือนงบประมาณอ้างอิง budgetTracking และ trackedBudgetSpent จากหน้าจัดการงบประมาณโดยตรง
- Dashboard จัด “แจ้งเตือนการเงิน” และ “แนวโน้มรายรับ–เงินออก” เป็น 2 คอลัมน์
- “หมวดที่ใกล้เต็มงบ” ใช้ข้อมูล budgetTracking ชุดเดียวกับหน้าจัดการงบประมาณ
- คงเลขรุ่น v0.3.0 Beta และโครงสร้าง build สำหรับ Setup.exe / Portable.exe
